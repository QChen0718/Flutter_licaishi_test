...
class MarketingClues extends StatefulWidget{
  @override
  _MarketingCluesState createState() => _MarketingCluesState();
  
}

class _MarketingCluesState extends State<MarketingClues>{
  @override
