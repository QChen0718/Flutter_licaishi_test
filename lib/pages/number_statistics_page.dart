...
class NumberStatisticsPage extends StatefulWidget{
  @override
  _NumberStatisticsPageState createState() => _NumberStatisticsPageState();
}
class _NumberStatisticsPageState extends State<NumberStatisticsPage>{
    @override
