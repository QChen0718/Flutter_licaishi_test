...
class _EditCardPageState extends State<EditCardPage>{
  ...
  void initState() {
    ...
    super.initState();
    _controllArray.add(_namecontroller);
    _controllArray.add(_phonecontroller);
    _controllArray.add(_emailcontroller);
    _controllArray.add(_wchartcontroller);
    _controllArray.add(_managercontroller);
    _controllArray.add(_servercontroller);
    _controllArray.add(_compationnamecontroller);
    _controllArray.add(_comprationaddresscontroller);
  }
  @override
